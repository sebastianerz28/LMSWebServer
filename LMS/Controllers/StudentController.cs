    ...
    public class StudentController : CommonController
    {
        ...
        public IActionResult GetMyClasses(string uid)
        {
            ...
            var query2 = from e in db.Enrolled
                         where e.UId == uid
                         join classes in db.Classes on e.ClassId equals classes.ClassId
                         select new
                         {
          ...
          string category, string asgname, string uid, string contents)
        {
            ...
            var query = from courses in db.Courses
                        ...
                        select new
                        {
                            aID = catAssign.AssignmentId
                        };
            var query2 = from assignmentID in query
                         join submissions in db.Submissions on assignmentID.aID equals submissions.AssignmentId
